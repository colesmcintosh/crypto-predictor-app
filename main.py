...
st.set_page_config(page_title='Crypto Price Predictions', layout = 'wide', initial_sidebar_state = 'auto')

st.title("Crypto Price Predictions")
data_load_state = st.text("Loading data...please allow 3-5 minutes...large computations occurring.")
